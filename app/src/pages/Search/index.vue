...
export default {
  ...
  computed: {
    //里面的写法：传递的数组，因为getters计算是没有划分模块的【home，search】
  ...
  methods: {
    ...
    //删除分类名字
    removeCategoryName() {
      //把带给服务器的参数置空，还是会带给服务器
      //但是把响应的字段变为undefined不会带给服务器
  ...
  watch: {
    ...
    $route(newValue, oldValue) {
      ...
      //再次发起ajax请求
      this.getData();
      //每次请求完毕，应该把响应的1、2、3级分类的id置空，让他接收下一次的响应id
      this.searchParams.category1Id = undefined;
      this.searchParams.category2Id = undefined;
      this.searchParams.category3Id = undefined;
    },
